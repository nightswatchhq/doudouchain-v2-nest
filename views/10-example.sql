...
--
-- Example over this nest's `collection_book_upgradeable__collection_book_claimed` table:
--
-- CREATE VIEW collection_book_upgradeable_activity AS
--   SELECT count(*) AS events,
--          min(block_number) AS first_block,
--          max(block_number) AS last_block
--   FROM "collection_book_upgradeable__collection_book_claimed";
