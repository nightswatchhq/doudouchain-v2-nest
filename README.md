...
An installable [Nuthatch](https://github.com/nightswatchhq/nuthatch) nest for the ICHICHAIN/Doudo
...
```sh
nuthatch init --from https://github.com/nightswatchhq/ichichain-nest
nuthatch dev --dir ichichain-nest --rpc https://your-arbitrum-archive-rpc
```
...
manifest. This includes ICHICHAIN ticket and prize activity, the series, bundle, refund, redraw and
...
Two source data sources share the ICHICHAIN address, and two share the VRF-router address. They
remain distinct tables because their Graph handlers serve distinct entity surfaces; this is not an
accidental duplicate scanner.
